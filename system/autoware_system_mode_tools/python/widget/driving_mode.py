...
class DrivingModeControl(QtWidgets.QWidget):
    ...
    def create_widget(self, modes):
        ...
        self.create_all_buttons(SystemModeStatusItem.CONTINUABLE, layout, 0, 1)
        self.create_all_buttons(SystemModeStatusItem.AVAILABLE, layout, 0, 4)
        self.create_all_buttons(SystemModeStatusItem.STABLE, layout, 0, 7)
